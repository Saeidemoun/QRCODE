  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        indigoShadow: "0px 0px 300px 350px rgba(184,176,255,0.75)",
        indigoLight: "0px 0px 150px 50px rgba(184,176,255,0.95)",
        forDark:
          "0 10px 15px -3px rgba(0, 0, 0, 0.8), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",
        forLight: "0 4px 8px rgba(0, 0, 0, 0.2)",
      },
      animation: {
        "border-move": "borderMove 6s ease-in infinite",
        "hero-reveal": "heroReveal 1s ease-in forwards",
      },
      keyframes: {
        borderMove: {
